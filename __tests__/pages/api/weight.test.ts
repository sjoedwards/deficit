...
import { calorieMock } from "./mocks/backend/calories/mock-default-calorie-data";
import { weightMock } from "./mocks/backend/weight/mock-default-weight-data";
import { authMock } from "./mocks/backend/auth/mock-default-auth-mock";
